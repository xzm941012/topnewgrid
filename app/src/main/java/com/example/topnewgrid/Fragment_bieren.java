 ...
 */
public class Fragment_bieren extends Fragment implements Handler.Callback {
    View view;
    public static Fragment_bieren fragment_geren;
                             ...
                             Bundle savedInstanceState)
    {
        ...
        view=inflater.inflate(R.layout.activity_xiugai4, container, false);
            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what){
                    case 1:
                        ...
                        ((TextView)view.findViewById(R.id.textView227)).setText(otherUser.getUserName());
                        fragmentList.add(new Fragment_bieren_view1());
                        fragmentList.add(new Fragment_bieren_view2());
                        fragmentList.add(new Fragment_bieren_view3());
                        titleList.add("个人资料");
                        titleList.add("发布");
                        titleList.add("参与");
                        ((ViewPager)view.findViewById(R.id.viewpager3)).setAdapter(new MyViewPagerAdapter(getActivity().getSupportFragmentManager()));
                        com.example.topnewgrid.obj.PagerSlidingTabStrip tabs = (com.example.topnewgrid.obj.PagerSlidingTabStrip) view.findViewById(R.id.tabs);
                        tabs.setViewPager((ViewPager)view.findViewById(R.id.viewpager3));
                        break;
                }
            }
        };
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    otherUser=((Activity_bieren)getActivity()).otherUser;
                    app.setOtherUser(otherUser);
                    //dialogHandler.sendEmptyMessage(1);
                    System.out.println("222");
                    Gson gson=new Gson();
                    SharedPreferences.Editor editor = AppApplication.userSharedPreferences.edit();
                    editor.putString(((Activity_bieren)getActivity()).id+"",gson.toJson(otherUser));
                    editor.commit();
    ...
    private void initUser(){
        ...
        user=new User();
        user.setUserId(((Activity_bieren)getActivity()).id);
        filename=user.getUserId()+".jpg";
    }

    private void initLayout(){
        view.findViewById(R.id.imageView221).setVisibility(View.VISIBLE);
        view.findViewById(R.id.imageView221).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                getActivity().finish();
            }
        });
        view.findViewById(R.id.textView263).setVisibility(View.GONE);
        tuichuButton=(TextView)view.findViewById(R.id.textView263);
        //touxiang=(RelativeLayout)findViewById(R.id.relativeLayout7);
        touxiangImageview=(ImageView)view.findViewById(R.id.imageView220);
        /*
        ...
        */
        ...
        imageLoader.displayImage("http://"+ PostUrl.Media+":8080/upload/"+user.getUserId()+".jpg", touxiangImageview, defaultOptions);
...
/*
        view.findViewById(R.id.imageView220).setOnClickListener(new View.OnClickListener() {
