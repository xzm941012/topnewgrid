 ...
 */
public class Fragment_geren extends Fragment implements Handler.Callback {
    View view;
    public static Fragment_geren fragment_geren;
            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what){
                    case 1:
                        ...
                        fragmentList.add(new Fragment_geren_view1());
                        fragmentList.add(new Fragment_geren_view2());
                        fragmentList.add(new Fragment_geren_view3());
                        ...
                        ((ViewPager)view.findViewById(R.id.viewpager3)).setOffscreenPageLimit(3);
