...
public class Activity_yaoqing extends FragmentActivity {
...
protected ImageLoader imageLoader = ImageLoader.getInstance();
        ...
        thread=new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    if(friendList!=null) {
                        adapter = new FriendAdapter(Activity_yaoqing.this, friendList);
    ...
    private void initHandler(){
        ...
        handler2=new Handler(){
            ...
            public void handleMessage(Message msg) {
                switch (msg.what){
                    case 0:
                        Toast.makeText(Activity_yaoqing.this, "添加成功", Toast.LENGTH_SHORT).show();
                        break;
                    case 1:
                        Toast.makeText(Activity_yaoqing.this,"添加失败",Toast.LENGTH_SHORT).show();
                        break;
                    case 2:
                        Toast.makeText(Activity_yaoqing.this,"没有更多了",Toast.LENGTH_SHORT).show();
                        listView.onRefreshComplete();
                        break;
                    case 3:
                        Toast.makeText(Activity_yaoqing.this,"点赞成功",Toast.LENGTH_SHORT).show();
                        break;
                    case 4:
                        Toast.makeText(Activity_yaoqing.this,"已发送邀请",Toast.LENGTH_SHORT).show();
                        break;
                }
        ...
        handler3=new Handler(){
            ...
            public void handleMessage(Message msg) {
                super.handleMessage(msg);
                imageDownloader = new ImageDownloader(Activity_yaoqing.this);
    ...
    private void initLayout(){
        ((SegmentedGroup)findViewById(R.id.segmented2)).setTintColor(getResources().getColor(R.color.radiobutton),getResources().getColor(R.color.activitybarblue));
    ...
    private void initListener(){
        ...
        find.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivityForResult(new Intent(Activity_yaoqing.this, Activity_findUser.class), ResultUtil.FINDUSER);
            }
        });
        ...
        */
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                AlertDialog.Builder builder = new AlertDialog.Builder(Activity_yaoqing.this);
                String[] a = {"邀请", "查看资料"};
                builder.setItems(a, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        switch (arg1) {
                            case 0:
                                System.out.println("邀请:" + adapter.mItems.get(position - 1).getUserName());
                                new Thread(new Runnable() {
                                    @Override
                                    public void run() {
                                        try {
                                            Manage.sendHuodongYaoqing(user.getUserId(), user.getName(), "3", huodongID, huodongName, adapter.mItems.get(position - 1).getId() + "");
                            ...
                            case 1:
                                ...
                                intent.setClass(Activity_yaoqing.this, Activity_bieren.class);
