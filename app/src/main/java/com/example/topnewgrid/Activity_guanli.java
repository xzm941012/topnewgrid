...
public class Activity_guanli extends FragmentActivity {
...
private AppApplication app;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog = new ProgressDialog(Activity_guanli.this);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    if(huodongList!=null) {
                        adapter = new HuodongAdapter(Activity_guanli.this, huodongList);
    ...
    private void initHandler(){
        ...
        handler=new Handler(){
            @Override
            public void handleMessage(Message msg) {
                listView.setAdapter((HuodongAdapter)msg.obj);
        ...
        handler2=new Handler(){
            ...
            public void handleMessage(Message msg) {
                switch (msg.what){
                    case 0:
                        Toast.makeText(Activity_guanli.this, "添加成功", Toast.LENGTH_SHORT).show();
                        break;
                    case 1:
                        Toast.makeText(Activity_guanli.this,"添加失败",Toast.LENGTH_SHORT).show();
                        break;
                    case 2:
                        Toast.makeText(Activity_guanli.this,"没有更多了",Toast.LENGTH_SHORT).show();
                        listView.onRefreshComplete();
                        break;
                    case 3:
                        Toast.makeText(Activity_guanli.this,"点赞成功",Toast.LENGTH_SHORT).show();
                        break;
                }
        ...
        handler3=new Handler(){
            ...
            public void handleMessage(Message msg) {
                super.handleMessage(msg);
                imageDownloader = new ImageDownloader(Activity_guanli.this);
        ...
        handler4=new Handler(){
            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what){
                    case 0:
                        adapter.mItems=(List<Huodong>)msg.obj;
                        adapter.notifyDataSetChanged();
                        listView.onRefreshComplete();
                        break;
                    case 1:
                        adapter.mItems.addAll((List<Huodong>)msg.obj);
                        adapter.notifyDataSetChanged();
                        listView.onRefreshComplete();
                        break;
                    case 2:
    ...
    private void initUser(){
        ...
        if(!user.getUserId().equals(id)){
            ((RadioButton)findViewById(R.id.button21)).setText("他发布的");
            ((RadioButton)findViewById(R.id.button22)).setText("他参与的");
            ((RadioButton)findViewById(R.id.button23)).setText("他收藏的");
        }
    }
    ...
    private void initListener(){
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, final int arg2, long arg3) {
                ...
                intent.setClass(Activity_guanli.this, Activity_huodong_xiangqing.class);
                Bundle mBundle = new Bundle();
                mBundle.putString("id",adapter.mItems.get(arg2-1).getHuodongId() + "");
                mBundle.putString("authorId",adapter.mItems.get(arg2-1).getAuthorId()+"");
        ...
        public View getView(int position, View view, ViewGroup parent) {
            ...
            */
            ...
            if(s[0].contains("mp4")||s[0].contains("wmv")||s[0].contains("avi")||s[0].contains("3gp")){
                ...
                imageLoader.displayImage("http://" + PostUrl.Media + ":8080/upload/" + s[0].split("\\.")[0]+".jpg",holder.tupian,defaultOptions);
            }else {
                //imageDownloader.download("http://" + PostUrl.Media + ":8080/upload/" + s[0], holder.tupian);
                imageLoader.displayImage("http://" + PostUrl.Media + ":8080/upload/" + s[0], holder.tupian, defaultOptions);
            }
