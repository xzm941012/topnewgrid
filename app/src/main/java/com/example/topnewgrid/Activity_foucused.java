...
public class Activity_foucused extends FragmentActivity {
...
protected ImageLoader imageLoader = ImageLoader.getInstance();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_foucused);
    ...
    private void initParam(){
        thread=new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    friendList= Manage.ViewUserByFriend(userId, "1", "1");
                    dialogHandler.sendEmptyMessage(1);
                    if(thread.isInterrupted()){
                        return;
                    }
                    if(friendList!=null) {
                        adapter = new FriendAdapter(Activity_foucused.this, friendList);
    ...
    private void initHandler(){
        ...
        handler2=new Handler(){
            ...
            public void handleMessage(Message msg) {
                switch (msg.what){
                    case 0:
                        Toast.makeText(Activity_foucused.this, "添加成功", Toast.LENGTH_SHORT).show();
                        break;
                    case 1:
                        Toast.makeText(Activity_foucused.this,"添加失败",Toast.LENGTH_SHORT).show();
                        break;
                    case 2:
                        Toast.makeText(Activity_foucused.this,"没有更多了",Toast.LENGTH_SHORT).show();
                        listView.onRefreshComplete();
                        break;
                    case 3:
                        Toast.makeText(Activity_foucused.this,"点赞成功",Toast.LENGTH_SHORT).show();
                        break;
                    case 4:
                        Toast.makeText(Activity_foucused.this,"已发送邀请",Toast.LENGTH_SHORT).show();
                        break;
                }
        ...
        handler3=new Handler(){
            ...
            public void handleMessage(Message msg) {
                super.handleMessage(msg);
                imageDownloader = new ImageDownloader(Activity_foucused.this);
    ...
    private void initListener(){
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                intent.setClass(Activity_foucused.this,Activity_bieren.class);
            ...
            public void onPullUpToRefresh(PullToRefreshBase<ListView> refreshView) {
                thread=new Thread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            List<OtherUser>friendList;
                            friendList= Manage.ViewUserByFriend(userId, i+1+"", "1");
                            if(friendList==null){
                                Message ms=new Message();
                                ms.what=2;
                                handler2.sendMessage(ms);
