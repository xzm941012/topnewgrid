 ...
 */
public class HuodongCardAdapter extends BaseAdapter {
    ...
    public HuodongCardAdapter(List<Huodong> URLS, Context context) {
        super();
        this.URLS=URLS;
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        holder.bofang.setVisibility(View.GONE);
            ...
            holder = new ViewHolder(view);
            */
        holder.fenlei.setText(item.getJoinMun()+"人参加");
        ...
        imageLoader.displayImage("http://" + PostUrl.Media + ":8080/upload/" + item.getAuthorId() + ".jpg" ,holder.touxiang,defaultOptions);
            ...
            if(item.getChuangjianTime().split(" ").length==2){
                ...
                */
        try {
            List<Label_edit> edits = gson.fromJson(item.getContent(), new TypeToken<List<Label_edit>>() {
            }.getType());
            for (Label_edit label_edit:edits){
                if(label_edit.getType()==0){
                    holder.time.setText(label_edit.getWenzi());
                    break;
                }
            }
        }catch (Exception e){
    ...
    public final class ViewHolder {
        ...
        public ViewHolder(View view){
            ...
            fenlei=(TextView)view.findViewById(R.id.textView81);
            address=(TextView)view.findViewById(R.id.textView82);
        }
    }
