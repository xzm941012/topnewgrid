...
public class Activity_find extends Activity {
    ...
    private Handler handler2,handler4;
    private HuodongLoadAdapter adapter;
    private ProgressDialog dialog;
    private Handler dialogHandler;
    private ImageDownloader imageDownloader;

    Handler mHandler,hander;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        requestWindowFeature(Window.FEATURE_NO_TITLE);
        setContentView(R.layout.activity_pindao_find);
    ...
    private void initHandler(){
        ...
        handler2=new Handler(){
            ...
            public void handleMessage(Message msg) {
                switch (msg.what){
                    case 0:
                        Toast.makeText(Activity_find.this,"没有更多了",Toast.LENGTH_SHORT).show();
                        break;
                    case 1:
    ...
    private void initLayout(){
        findButton=(TextView)findViewById(R.id.textView64);
        listView=(PullToRefreshListView)findViewById(R.id.listView6);
        tag=(EditText)findViewById(R.id.editText5);
    }
    private void initListener(){
                    ...
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            try {
                                ...
                                List<Huodong> huodongList=Manage.ResearchActivity(tag.getText().toString().trim(),"1");
                                ...
                                adapter=new HuodongLoadAdapter( Activity_find.this,huodongList);
                                Message ms=new Message();
                                ms.what=1;
                                ms.obj=adapter;
                                handler2.sendMessage(ms);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, final View view, final int position, long id) {
                ...
                intent.setClass(Activity_find.this, Activity_huodong_xiangqing.class);
                Bundle mBundle = new Bundle();
                mBundle.putString("id",adapter.mItems.get(position-1).getHuodongId() + "");
                mBundle.putString("authorId",adapter.mItems.get(position-1).getAuthorId()+"");
        ...
        listView.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ListView>() {
            ...
            public void onPullUpToRefresh(PullToRefreshBase<ListView> refreshView) {
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            List<Huodong> huodongList=Manage.ResearchActivity(tag.getText().toString().trim(),pageNum+1+"");
                            if(huodongList==null){
                                Message ms=new Message();
                                ms.what=0;
                                handler2.sendMessage(ms);
    ...
    public class HuodongLoadAdapter extends BaseAdapter {
        ...
        public HuodongLoadAdapter( Context context,List<Huodong> URLS) {
            super();
            this.mItems=URLS;
            ...
            */
            ...
            if (!item.getStyle().equals("活动")) {
                ...
                if (item.getFengmianUrl() != null && !item.getFengmianUrl().equals("")) {
                    ...
                    imageDownloader.download("http://" + PostUrl.Media + ":8080/upload/" + s[0], tupian);
