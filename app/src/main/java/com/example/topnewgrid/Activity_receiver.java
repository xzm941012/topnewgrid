 ...
 */
public class Activity_receiver extends Activity {
    ...
    private String huodongID,userID,huodongTitle,myId;
    ...
    private void initHandler(){
        ...
        handler2=new Handler(){
            ...
            public void handleMessage(Message msg) {
                switch (msg.what){
                    case 0:
                        Toast.makeText(Activity_receiver.this,"添加成功",Toast.LENGTH_SHORT).show();
                        content.clearFocus();
                        content.setText("");
                        break;
                    case 1:
                        Toast.makeText(Activity_receiver.this,"添加失败",Toast.LENGTH_SHORT).show();
                        content.clearFocus();
                        content.setText("");
                        break;
                    case 2:
                        Toast.makeText(Activity_receiver.this,"没有更多了",Toast.LENGTH_SHORT).show();
            ...
            public void handleMessage(Message msg) {
                switch (msg.what){
                    case 0:
                        ...
                        imageDownloader = new ImageDownloader(Activity_receiver.this);
                        //imageDownloader.download("http://" + PostUrl.Url + ":8080/upload/" + map.get("picturePath") ,(ImageView) map.get("view"));
                        imageLoader.displayImage("http://" + PostUrl.Media + ":8080/upload/" + map.get("picturePath"),(ImageView) map.get("view"),defaultOptions);
                        break;
                    case 1:
    ...
    private void initParam(){
        ...
        huodongTitle=bundle.getString("huodongTitle");
        myId=bundle.getString("myId");

        if(myId.equals("")||!myId.equals(userID)){
              findViewById(R.id.textView154).setVisibility(View.GONE);
        }

        System.out.println("活动id是："+huodongID);
        System.out.println("作者id是：" + userID);
        thread=new Thread(new Runnable() {
            @Override
            public void run() {
                try {
                    dialogHandler.sendEmptyMessage(0);
                    List<PinglunItem> receiverList=Manage.ViewBroadcastByActivity(huodongID, "1");
                    dialogHandler.sendEmptyMessage(1);
                    if(thread.isInterrupted()){
                        return;
                    }
                    if(receiverList!=null) {
                        pinglunAdapter = new ReceiverAdapter(Activity_receiver.this, receiverList);
    ...
    private void initListener(){
        ...
        pinglun.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                intent.setClass(Activity_receiver.this,Activity_receiver_pinglun.class);
        ...
        findViewById(R.id.textView154).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(Activity_receiver.this, Activity_fabu_receiver.class);
                Bundle bundle = new Bundle();
                bundle.putString("huodongID", huodongID);
        ...
        pinglun.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ListView>() {
            ...
            public void onPullUpToRefresh(PullToRefreshBase<ListView> refreshView) {
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            List<PinglunItem> receiverList = Manage.ViewBroadcastByActivity(huodongID, i + 1 + "");
                            if (receiverList == null) {
                                Message ms = new Message();
                                ms.what = 2;
                                handler2.sendMessage(ms);
    ...
    public class PinglunAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if(item.getMediaPath()!=null&&!("").equals(item.getMediaPath())){
                ...
                convertView.findViewById(R.id.imageView237).setVisibility(View.VISIBLE);
                imageLoader.displayImage("http://" + PostUrl.Media + ":8080/upload/" +mediaPath.get(0).split("\\.")[0]+".jpg" ,videoView);
                ...
                convertView.findViewById(R.id.imageView162).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        */
                        Intent it = new Intent(Intent.ACTION_VIEW);
                        Uri uri = Uri.parse("http://"+PostUrl.Media+":8080/upload/"+item.getMediaPath().get(0));
                ...
                convertView.findViewById(R.id.textView151).setVisibility(View.GONE);
                convertView.findViewById(R.id.textView160).setVisibility(View.GONE);
                convertView.findViewById(R.id.textView159).setVisibility(View.GONE);
                convertView.findViewById(R.id.textView158).setVisibility(View.GONE);
