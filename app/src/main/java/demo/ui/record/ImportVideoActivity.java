...
import demo.ui.widget.VideoView;
...
public class ImportVideoActivity extends BaseActivity implements OnClickListener, OnPreparedListener, VideoView.OnPlayStateListener {
		...
		if (!isFinishing() && mMediaObject != null && mMediaPart != null) {
			new AsyncTask<Void, Void, Boolean>() {
				...
				protected Boolean doInBackground(Void... params) {
                    ...
                    //return FFMpegUtils.videoTranscoding(mMediaObject, mMediaObject.getOutputVideoPath(), mWindowWidth, false);
				}
	...
	public void onPrepared(MediaPlayer mp) {
		if (!isFinishing()) {
            ...
            //mMediaPart = mMediaObject.buildMediaPart(mVideoPath, mVideoView.getDuration(), MediaObject.MEDIA_PART_TYPE_IMPORT_VIDEO);
