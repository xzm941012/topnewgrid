...
import demo.ui.record.MediaRecorderActivity;
...
import mediachooser.fragment.BucketVideoFragment;
...
public class BucketHomeFragmentActivity extends FragmentActivity {
		...
		public void onClick(View view) {
			if(view == headerBarCamera){
				...
				if(view.getTag().toString().equals(getResources().getString(R.string.video))){
                    ...
                    startActivityForResult(new Intent(BucketHomeFragmentActivity.this, MediaRecorderActivity.class),999);
	...
	private static File getOutputMediaFile(int type){
       // System.out.println("前缀:"+Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES));
        ...
        System.out.println("路径为："+mediaStorageDir.getPath() + File.separator);
		return mediaFile;
	}
